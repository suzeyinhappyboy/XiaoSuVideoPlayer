...
public class VideoViewDemo extends Activity {
	...
	public void onCreate(Bundle icicle) {
		...
		System.out.println("playVideoFile.getPath()="+mPath);
		playfunction(mPath);	

	}

	
	void playfunction(String mPath){
		 String path = "";
		 path=mPath;
		...
		if (path == "") {
			...
			Toast.makeText(VideoViewDemo.this, "Please edit VideoViewDemo Activity, "
					+ "and set path" + " variable to your media file URL/path",
